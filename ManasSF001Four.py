...
"""
[Tata]: Provision access-design, assuming 1 vpn, 2 sub-VPN already present. Validate access-design provisioning.

Question: Does multiple access-deisgn need to be created to faciliatate later multi access-deisgn deletion scenario??
...
"""
class TataSF001Four(Automation.Testcase):
    ...
    def __init__(self,tbFile,configFile,manifest,debug=True,displayName=None):
        ...
        self.subtests_list = [
            ...
            'subvpn_deletion', 'FUNC006 vpn deletion', 'tata ad verify'
        ]
    ...
    def run(self):
        ...
        logger.debug('create_vpn={}, verify_vpn={}, create_ad={}, do_pings={}'.format(create_ad, tata_verify_ad, do_pings))
        ...
        sub3 = self.configFile.configFile['service_chain']['subvpn_name3']
...
"""
class TataSF001Four(Automation.ScriptTemplate):
